package net.joe.tutorialmod.item;

import net.joe.tutorialmod.TutorialMod;
import net.joe.tutorialmod.block.ModBlocks;
    ...
    public static final RegistryObject<CreativeModeTab> CUSTOM_TAB = CREATIVE_MODE_TABS.register("custom_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.SAPPHIRE.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModBlocks.STATE_BLOCK.get());
                        output.accept(ModBlocks.TRANSITION_BLOCK.get());
                    })
                    .build());
